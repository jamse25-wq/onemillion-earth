  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
      ...
      <div className="mb-20">
        ...
        <p className="text-[#7aab8a] text-xl leading-relaxed mb-6">
      ...
      <section className="mb-20">
        <h2 className="text-2xl font-bold text-[#e8f5e9] mb-10">
          How it works
        </h2>
          ...
          {[
            ...
            <div key={step} className="flex gap-6">
              <div className="shrink-0 mt-1">
                <div className="w-10 h-10 rounded-full border border-[#3ddc84]/30 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-[#7aab8a] leading-relaxed">{body}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="mb-20">
        ...
        <div className="space-y-4 text-[#7aab8a] leading-relaxed">
          <p>
            The voluntary carbon market has a credibility problem. Greenwash is
            rampant. "Carbon neutral" claims are everywhere. Companies buy cheap,
            low-quality credits and use them to avoid doing anything meaningful.
          </p>
          <p>
            We wanted to build something different: a platform that is radically
            honest about what carbon credits are and aren't, that only lists
            high-quality certified projects, and that makes the mechanics
            completely transparent.
          </p>
          <p>
            The globe is part of that transparency. When you fund a tonne, you
            see exactly where it sits in the one million. You can watch progress
            in real time. It's not a certificate you file and forget — it's a
            living record of collective action.
          </p>
          <p>
            We don't use the word "offset". We don't promise "carbon neutrality".
            We say: here is a real project, here is what it does, here is what
            your money funds. That's it.
          </p>
        </div>
      </section>

      {/* Platform fee */}
      <section className="p-6 rounded-2xl border border-white/8 bg-[#111811] mb-16">
        <h2 className="text-[#e8f5e9] font-semibold mb-4">
          Our platform fee
        </h2>
        <p className="text-[#7aab8a] text-sm leading-relaxed mb-3">
          We charge an 18% platform fee on each transaction. This covers:
        </p>
        <ul className="space-y-2 text-[#7aab8a] text-sm">
          {[
            ...
            <li key={item} className="flex items-start gap-2">
              <span className="text-[#3ddc84] mt-0.5">·</span>
              {item}
            </li>
          ))}
        </ul>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <Link
          href="/projects"
          className="px-6 py-3 rounded-full bg-[#3ddc84] text-[#0a0f0a] font-semibold text-sm hover:bg-[#3ddc84]/90 transition-colors text-center"
        >
          View Projects
        </Link>
        <Link
          href="/verify"
          className="px-6 py-3 rounded-full border border-white/10 text-[#7aab8a] font-medium text-sm hover:text-[#e8f5e9] hover:border-white/20 transition-colors text-center"
        >
          Verify our claims
        </Link>
      </div>
