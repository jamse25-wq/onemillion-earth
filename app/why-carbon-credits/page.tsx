  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        {/* Main content */}
        <div className="space-y-12 text-[#555f55] text-base leading-relaxed">
          {/* Section 1 */}
          <section>
            ...
            <p className="mb-4">
              ...
              removed from the atmosphere, or prevented from entering it. When
              you buy and retire a credit, that tonne can never be sold again.
            </p>
            <p>
              The key word is &ldquo;verified&rdquo;. Anyone can claim to have planted a
              tree. A carbon credit means an independent registry has checked
              the methodology, measured the actual impact, and certified the
              result. It&apos;s a claim backed by evidence, not a promise backed by
              marketing.
            </p>
          </section>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p>
                  The carbon impact must be additional — meaning it wouldn&apos;t
                  have happened without the credit revenue. A forest that would
                  have been protected anyway doesn&apos;t count. The project has to
                  prove that funding was the deciding factor.
                </p>
                <p className="mt-3 text-[#555f55] text-sm">
                  This is the most scrutinised criterion, and the reason we
                  only work with certified registries.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p>
                  ...
                  protect biodiversity, improve community livelihoods, clean
                  water sources, or restore habitat. We select projects that
                  deliver these co-benefits alongside the core climate impact.
                </p>
                <p className="mt-3 text-[#555f55] text-sm">
                  A peatland restoration that also creates rare species habitat
                  and prevents downstream flooding is a better project than one
                  that only sequesters carbon.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-4">
              ...
              >
                ...
                <p className="text-sm">
                  Emissions that would otherwise have occurred are prevented.
                  Not sequestration, but still real impact. Projects: Kenya
                  cookstoves, Amazon REDD+.
                </p>
              </div>
            </div>
            <p>
              Both matter. We&apos;re transparent about which type each project is.
              We never mix them up or pretend avoidance is the same as removal.
            </p>
          </section>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={claim} className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-[#1a1a1a] font-medium">{claim}</p>
                    <p className="text-[#555f55] text-sm mt-0.5">{detail}</p>
                  </div>
                </li>
              ))}
            </ul>
